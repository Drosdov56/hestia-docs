...
7. **Aucun chantier actif.** Le prochain développement repart depuis cet état stabilisé — uniquement sur demande explicite.
8. Signaler uniquement les divergences factuelles éventuelles.
