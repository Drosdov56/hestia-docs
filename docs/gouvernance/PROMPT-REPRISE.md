...
8. **Aucun chantier actif.** Prochain candidat backlog : **EPIC-005** (Hub familial & notifications) — uniquement sur demande explicite.
9. Signaler uniquement les divergences factuelles éventuelles.
